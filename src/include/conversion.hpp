/// Conversion utilities between iceberg-cpp and DuckDB types, values, filters and S3 configuration.
...
/// Converts iceberg-cpp S3 properties, e.g. vended table IO properties, to DuckDB S3 secret options.
